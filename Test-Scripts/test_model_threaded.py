...
def load_model():
    return YOLO("./models/single_model0.1.1.pt")
...
def process_image(image_path):
    with torch.no_grad():  # Disable gradient computation to save memory and speed up inference
        ...
        return (result.probs.top1 == 2), image_path  # Return if correct + image path

if __name__ == "__main__":
    start_time = time.perf_counter()

    # Path to folder containing images
    folder_path = "/home/landon/Senior-Design/Training/phragmites"
